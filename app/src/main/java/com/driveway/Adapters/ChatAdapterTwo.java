...
public class ChatAdapterTwo extends BaseAdapter {

    ArrayList<ChatModel> list;
    Context context;
    LayoutInflater inflater;
    SearchPropertyModel obj;
    DataContext dataContext;
    public ChatAdapterTwo(Context context, ArrayList<ChatModel> list, SearchPropertyModel obj) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(model!=null){
            ...
            if(!model.messageType.equalsIgnoreCase("text")){
                ...
                if(model.receiver.equalsIgnoreCase(dataContext.tblUserObjectSet.get(0).APIToken)) {
            ...
            holder.tvDate.setText(DateFormat.format("hh:mm a", new Date(model.timeStamp*1000)).toString() + "");
            //if (obj != null && !obj.owneruser.FullName.isEmpty())
                holder.UserCharacter.setText(dataContext.tblUserObjectSet.get(0).APIToken.equalsIgnoreCase(obj.userDetail.APIToken)?obj.userDetail.FullName.charAt(0) + "":obj.userDetail.FullName.charAt(0) +"");
        }
        return convertView;
    }
    public class Holder{
